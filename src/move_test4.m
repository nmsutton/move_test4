...
pd_match=mult_ex*70;%60.5;%70;%63%;75;%78;%75;%80;%68;%67;%132;%58;%%115;%89;%88;%74;%71.5;%83;%83;%60;%51;%42;%34.4;%43;
pd_nonmatch=60*mult_ex;%60;%90;%30;%80;%60;
mult_in = 900;%1000;%1000000;%1000;%5000;%200;%230;%250;%330;%27;
gc_to_in_wt = mult_in*45;%15;%25;%25;%25;%180;%25;%36;%47;%100;%180;%180;%30;%39;%180;%0.4;%0.2;%0.121;%;//0.12;%0.15; % gc to in synapse weight
...
gei = 1.0;
cap_ui = 0.05;%0.1119;%0.025;%0.1638;%0.01;%0.1638;%0.1119;%0.135;%0.1119;%0.2712;%0.15;%0.1119;%1;%.8;%1;%.4;%.5;%.6;%.8;%1;%.8;%9;%0.2; % U, utilization
...
tau_di = 400;%160;%25;%35;%28;%35;%28;%24;%20;%28;%38.5;%23;%28;%22;%20;%15;%40;%40.0; % x signal decay time constant
